...
namespace Utilities
{
    ...
    public struct Masker8
    {
        private byte _data;
        private static readonly byte SIZE = 8;

        public Masker8(byte data)
        {
            this._data = data;
        }
        ...
        public static Masker8 operator <<(Masker8 mask, int value)
        {
            mask._data = 1;
            mask._data <<= value;
            return mask;
        ...
        public static bool operator ==(Masker8 mask1, Masker8 mask2)
            => mask1._data == mask2._data;

        public static bool operator !=(Masker8 mask1, Masker8 mask2)
            => mask1._data != mask2._data;

        public static bool operator ==(Masker8 mask1, uint mask2)
            => mask1._data == mask2;

        public static bool operator !=(Masker8 mask1, uint mask2)
            => mask1._data != mask2;

        public static bool operator ==(uint mask1, Masker8 mask2)
            => mask1 == mask2._data;
        ...
        public bool this[int index]
        {
            ...
            set
            {
                ...
                _data = value ? (byte)(_data | (byte)(1 << index)) : (byte)(_data & (byte)~(1 << index));
            }
        }
        ...
        public override bool Equals(object obj)
        {
            return obj is Masker8 masker && _data == masker._data;
        }
